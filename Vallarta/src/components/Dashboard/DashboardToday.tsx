...
export default function DashboardToday({ data, propertyName, propertyLocation, onNavigate, onDomainChange }: DashboardTodayProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: 'clamp(0.75rem, 1.5vw, 1.25rem) clamp(1.5rem, 3vw, 2.5rem) clamp(1.5rem, 3vw, 2rem)', gap: 'clamp(1rem, 2vw, 1.5rem)', overflow: 'hidden', justifyContent: 'flex-start' }}>
